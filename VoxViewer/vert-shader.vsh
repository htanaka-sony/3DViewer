...
in vec3 acolorTEST01; //半透明　面ごとに別
//-end- kuroda
...
void main()
{
    ...
    //本番用　2021.02.10//varying_myColor = vec4(prelightIntensity, acolorOne ); //全部、半透明(指定透明度 = 0.3など）にする。
    //
    ...
    float tmp_acolor = acolorTEST01.x; //vector2から[0]番目取り出し
    varying_myColor = vec4(prelightIntensity, tmp_acolor );
